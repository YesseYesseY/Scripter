...
namespace ScripterSharp.UE
{
    ...
    {
        public EFunctionFlags FunctionFlags => *(EFunctionFlags*)_obj.GetPtrOffset(Offsets.FunctionFlags);

        // UStruct
        private UStruct _obj;
        public UStruct* SuperStruct => _obj.SuperStruct;
        public UField* Children => _obj.Children;
        public int PropertiesSize => _obj.PropertiesSize;

        public bool IsA(UObject* Class) => _obj.IsA(Class);
        // UField
